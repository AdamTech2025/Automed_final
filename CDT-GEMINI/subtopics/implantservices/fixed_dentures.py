...
def create_fixed_dentures_extractor():
    ...
    """
    llm = ChatGoogleGenerativeAI(model="models/gemini-2.0-flash-thinking-exp-01-21", temperature=0.0)    
    template = f"""
...
def activate_implant_supported_fixed_dentures(scenario):
    """
    Analyze a dental scenario to determine implant/abutment supported fixed dentures (hybrid prosthesis) code.
